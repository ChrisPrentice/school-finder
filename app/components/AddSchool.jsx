    ...
    render:function(){
        return(
            <form className="form" onSubmit={this.addSchool}>
                ...
                <div className="form-group">
                    <label className="control-label" htmlFor="tagline">Location:</label>
                    <input type="text" className="form-control" id="tagline" name="tagline" value={this.state.address} onChange={this.handleInputChange} placeholder="Location" />                    
                </div>
                <div className="form-group">
